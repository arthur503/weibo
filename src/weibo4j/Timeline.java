...
public class Timeline extends Weibo{
	...
	public StatusWapper getUserTimeline(Integer count) throws WeiboException {
		return Status.constructWapperStatus(client.get(WeiboConfig
				.getValue("baseURL") + "statuses/user_timeline.json?count="+count+"&page=1")
		);
	}
	public StatusWapper getUserTimeline(Integer count, Integer page) throws WeiboException {
		return Status.constructWapperStatus(client.get(WeiboConfig
				.getValue("baseURL") + "statuses/user_timeline.json?count="+count+"&page="+page)
		);
	}
	public StatusWapper getUserTimeline(Integer feature, Integer count, Integer page) throws WeiboException {
		return Status.constructWapperStatus(client.get(WeiboConfig
				.getValue("baseURL") + "statuses/user_timeline.json?feature="+feature+"count="+count+"page="+page)
		);
	}
	...
	public StatusWapper getBilateralTimeline(Integer feature) throws WeiboException{
		return Status.constructWapperStatus(client.get(WeiboConfig.getValue("baseURL")+"statuses/bilateral_timeline.json",
				new PostParameter[]{
			new PostParameter("feature",feature)
		}));
