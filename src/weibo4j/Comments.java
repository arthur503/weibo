...
public class Comments extends Weibo{
	...
	public CommentWapper getCommentTimeline(Integer count, Paging page) throws WeiboException {
		return Comment.constructWapperComments(client.get(
				WeiboConfig.getValue("baseURL") + "comments/timeline.json?count="+count,
				null, page));
	}
